...
public class CharacterList {
	...
	public static Character getSira() {
		State state = new State("Sira", 50, 50, 50, CharacterSkill.siraSkill(1), CharacterSkill.siraSkill(2),
	...
	public static Character getCheTT() {
		State state = new State("CheTT", 80, 40, 30, CharacterSkill.CheTTSkill(1), CharacterSkill.CheTTSkill(2),
	...
	public static Character getMystery() {
		...
		State state = new State("Mystery", strRan, dexRan, hpRan, CharacterSkill.MysterySkill(1),
				CharacterSkill.MysterySkill(2), CharacterSkill.MysterySkill(3), CharacterSkill.MysterySkill(4),
				CharacterSkill.MysterySkill(5));
		return new Character(state);
	}

	public static Character getMin() {
		State state = new State("Min", 30, 20, 100, CharacterSkill.MinSkill(1), CharacterSkill.MinSkill(2),
